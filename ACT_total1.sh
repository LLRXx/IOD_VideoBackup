echo "--K $1  --split $2"
rm -r ../result/inference_TEA_STA_K8S1_30/frame_detections.pkl
echo "ACT 0.5"
python3 ACT.py --pkl_ACT 1 --task frameAP --K $1   --th 0.5 --inference_dir ../result/inference_TEA_STA_K8S1_30 --dataset IODVideo --split $2
echo "ACT 0.75"
python3 ACT.py --pkl_ACT 1 --task frameAP --K $1   --th 0.75 --inference_dir ../result/inference_TEA_STA_K8S1_30 --dataset IODVideo --split $2
echo "ACT all 0.5-0.95"
python3 ACT.py --pkl_ACT 1 --task frameAP_all --K $1  --inference_dir ../result/inference_TEA_STA_K8S1_30 --dataset IODVideo --split $2
