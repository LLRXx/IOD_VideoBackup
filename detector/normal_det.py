    ...
    def __init__(self, opt):
        ...
        if opt.rgb_model != '':
            ...
            self.rgb_model = create_model(
                ...
                use_scam=getattr(opt, 'use_scam', False),
                scam_reduction=getattr(opt, 'scam_reduction', 16),
                scam_spatial_kernel=getattr(opt, 'scam_spatial_kernel', 4),
                scam_channel_group=getattr(opt, 'scam_channel_group', 4),
                scam_residual_scale=getattr(opt, 'scam_residual_scale', 0.1),
